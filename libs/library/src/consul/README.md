...
import { ConsulModule } from '@app/library/consul';
...
import { ConsulService } from '@app/library/consul';
...
export class MyService {
  ...
  async discoverOtherService() {
    ...
    const healthyServices =
      await this.consulService.getHealthyService('other-service');
  ...
  async updateHealthCheck() {
    // 更新 TTL 健康检查状态
    await this.consulService.updateTTLHealthCheck(
